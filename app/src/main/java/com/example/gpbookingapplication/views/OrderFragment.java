...
import com.example.gpbookingapplication.databinding.FragmentOrderBinding;
...
public class OrderFragment extends Fragment {
 ...
 //       return inflater.inflate(R.layout.fragment_order, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOrderBinding.Gotohomepage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_orderFragment_to_profileActivity);
            }
        });
    }
}