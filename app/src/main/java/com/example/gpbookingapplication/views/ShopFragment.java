package com.example.gpbookingapplication.views;
...
import com.example.gpbookingapplication.adapters.ShopListAdapter;
import com.example.gpbookingapplication.databinding.FragmentShopBinding;
import com.example.gpbookingapplication.models.Product;
import com.example.gpbookingapplication.viewmodels.ShopViewModel;
...
public class ShopFragment extends Fragment implements ShopListAdapter.ShopInterface{
    ...
    public void addItem(Product product) {
        ...
        if (isAdded){
            ...
            Snackbar.make(requireView(), "This drug can not be bought more than two !!", Snackbar.LENGTH_LONG)
                    .show();
        }
    }
