...
public class Specialist_Mr_Paul_Robert extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    EditText date_in;
    EditText specialist_Mr_Paul_Robert;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specialist_mr_paul_robert);
        ...
        specialist_Mr_Paul_Robert = findViewById(R.id.specialist_Mr_Paul_Robert);
        specialist_Mr_Paul_Robert.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = specialist_Mr_Paul_Robert.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            specialist_Mr_Paul_Robert.setText("");
