...
public class Specialist_Mr_William_Hentry extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    EditText date_in;
    EditText specialist_Mr_William_Hentry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specialist_mr_william_hentry);
        ...
        specialist_Mr_William_Hentry = findViewById(R.id.specialist_Mr_William_Hentry);
        specialist_Mr_William_Hentry.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = specialist_Mr_William_Hentry.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            specialist_Mr_William_Hentry.setText("");
