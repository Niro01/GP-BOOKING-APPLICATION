package com.example.gpbookingapplication.specialist;
...
import com.example.gpbookingapplication.BookSpecialist;
...
public class Specialist_Miss_Emily_Elizabeth extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener {
    ...
    EditText date_in;
    EditText specialist_Miss_Emily_Elizabeth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specialist_miss_emily_elizabeth);
        ...
        specialist_Miss_Emily_Elizabeth = findViewById(R.id.specialist_Miss_Emily_Elizabeth);
        specialist_Miss_Emily_Elizabeth.setInputType(InputType.TYPE_NULL);
    ...
    private static final String[] times = new String[]{
            "03:00 - 03:20 PM", "03:25 - 03:40 PM",
            "03:45 - 04:10 PM", "04:15 - 04:30 PM",
            "04:35 - 04:50 PM"
    };
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.back:
                startActivity(new Intent(this, BookSpecialist.class));
                break;
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = specialist_Miss_Emily_Elizabeth.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            specialist_Miss_Emily_Elizabeth.setText("");
