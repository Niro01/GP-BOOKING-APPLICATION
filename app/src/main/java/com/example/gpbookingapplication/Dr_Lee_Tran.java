...
public class Dr_Lee_Tran extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dr_lee_tran);
        ...
        Dr_Lee_Tran = findViewById(R.id.Dr_Lee_Tran);
        Dr_Lee_Tran.setInputType(InputType.TYPE_NULL);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        calendar.set(Calendar.DAY_OF_WEEK,dayOfMonth,5);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = Dr_Lee_Tran.getText().toString().trim();
