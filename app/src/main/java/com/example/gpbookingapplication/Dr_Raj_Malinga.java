...
public class Dr_Raj_Malinga extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dr_raj_malinga);
        ...
        Dr_Raj_Malinga = findViewById(R.id.Dr_Raj_Malinga);
        Dr_Raj_Malinga.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = Dr_Raj_Malinga.getText().toString().trim();
