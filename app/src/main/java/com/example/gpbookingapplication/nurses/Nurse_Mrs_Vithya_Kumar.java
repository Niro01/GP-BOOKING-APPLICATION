...
public class Nurse_Mrs_Vithya_Kumar extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener {
    ...
    EditText date_in;
    EditText nurse_Mrs_Vithya_Kumar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nurse_mrs_vithya_kumar);
        ...
        nurse_Mrs_Vithya_Kumar = findViewById(R.id.nurse_Mrs_Vithya_Kumar);
        nurse_Mrs_Vithya_Kumar.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = nurse_Mrs_Vithya_Kumar.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            nurse_Mrs_Vithya_Kumar.setText("");
