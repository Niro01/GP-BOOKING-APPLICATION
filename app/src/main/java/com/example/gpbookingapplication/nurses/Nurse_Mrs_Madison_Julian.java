...
public class Nurse_Mrs_Madison_Julian extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
        ...
        EditText date_in;
        EditText nurse_Mrs_Madison_Julian;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nurse_mrs_madison_julian);
        ...
        nurse_Mrs_Madison_Julian = findViewById(R.id.nurse_Mrs_Madison_Julian);
        nurse_Mrs_Madison_Julian.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = nurse_Mrs_Madison_Julian.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            nurse_Mrs_Madison_Julian.setText("");
