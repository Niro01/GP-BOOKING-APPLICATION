...
public class Nurse_Miss_Lena_Anroosh extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    EditText date_in;
    EditText nurse_Miss_Lena_Anroosh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nurse_miss_lena_anroosh);
        ...
        nurse_Miss_Lena_Anroosh = findViewById(R.id.nurse_Miss_Lena_Anroosh);
        nurse_Miss_Lena_Anroosh.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = nurse_Miss_Lena_Anroosh.getText().toString().trim();
        ...
        if (sKey != null) {
            ...
            nurse_Miss_Lena_Anroosh.setText("");
