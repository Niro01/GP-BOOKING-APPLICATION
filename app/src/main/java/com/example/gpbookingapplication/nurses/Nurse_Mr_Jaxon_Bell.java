...
public class Nurse_Mr_Jaxon_Bell extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nurse_mr_jaxon_bell);
        ...
        nurse_Mr_Jaxon_Bell = findViewById(R.id.nurse_Mr_Jaxon_Bell);
        nurse_Mr_Jaxon_Bell.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = nurse_Mr_Jaxon_Bell.getText().toString().trim();
