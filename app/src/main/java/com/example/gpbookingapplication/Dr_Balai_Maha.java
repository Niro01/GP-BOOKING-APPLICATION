...
public class Dr_Balai_Maha extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dr_balai_maha);
        ...
        Dr_Balia_Maha = findViewById(R.id.Dr_Balia_Maha);
        Dr_Balia_Maha.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = Dr_Balia_Maha.getText().toString().trim();
