...
public class Dr_Kamila_Ahmed extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dr_kamila_ahmed);
        ...
        Dr_Kamila_Ahmed = findViewById(R.id.Dr_Kamila_Ahmed);
        Dr_Kamila_Ahmed.setInputType(InputType.TYPE_NULL);
    ...
    public void ConfirmationSubmit(View view) {
        ...
        String appointedName = Dr_Kamila_Ahmed.getText().toString().trim();
